...
public class SysUserController {
    ...
    public Result list(@PathVariable Long page,
        ...
        //创建page对象
        Page<SysUser> pagePaem = new Page<>(page,limit);
        //调用service方法
        IPage<SysUser> pageModel1 = sysUserService.selectPage(pagePaem,sysUserQueryVo);
    ...
    public Result remove(@PathVariable SysUser id){
